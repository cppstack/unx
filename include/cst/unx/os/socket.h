...
int Connect(int sockfd, const struct sockaddr* addr, socklen_t addrlen, std::error_code* ec = nullptr);

int Bind(int sockfd, const struct sockaddr* addr, socklen_t addrlen, std::error_code* ec = nullptr);

int Listen(int sockfd, int backlog, std::error_code* ec = nullptr);

int Accept(int sockfd, struct sockaddr* addr, socklen_t* addrlen, std::error_code* ec = nullptr);
int Accept4(int sockfd, struct sockaddr* addr, socklen_t* addrlen, int flags, std::error_code* ec = nullptr);
